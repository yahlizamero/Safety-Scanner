##### SafetyScanner – Local Development Setup #####

This project uses a React (Vite) frontend and a Node.js (Express) backend.
AI requests (including image analysis) are handled server-side.
...
-I mage files are converted to base64 in the client and sent to the backend
- Frontend calls:
